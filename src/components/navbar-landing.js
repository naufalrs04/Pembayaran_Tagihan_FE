    ...
    >
      <div className="flex justify-between items-center py-3 px-4 md:px-8 lg:px-16">
        <div className="flex items-center">
          ...
          <span className={`mt-2 ml-2 text-xl font-bold transition-colors duration-300 ${
            isScrolled ? "text-[#0798C5]" : "text-white"
          }`}>
        ...
        <Link
          ...
          className={`hidden lg:block px-6 py-2 rounded-xl hover:shadow-lg transition-all duration-200 transform hover:scale-105 cursor-pointer 
            ${
              isScrolled ? "bg-[#0798C5] text-white" : "bg-white text-[#0798C5]"
            }`}
        >
          Masuk
        </Link>
